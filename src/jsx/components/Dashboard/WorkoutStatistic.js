...
const ApexLine = loadable(() =>
   pMinDelay(import("../charts/apexcharts/Line"), 500)
);
const ApexLine2 = loadable(() =>
   pMinDelay(import("../charts/apexcharts/Line2"), 500)
);
const ApexPie = loadable(() =>
   pMinDelay(import("../charts/apexcharts/Pie"), 500)
);
